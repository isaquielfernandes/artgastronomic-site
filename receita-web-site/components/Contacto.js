...
const Contacto = () => (
    <div>
        ...
        <div id="contact" className="container section">
            <aside className="card address p-2">
            <h2 >Find Us</h2>
            <div className="row justify-content-sm-center">
                ...
                <p className="col-sm-12 col-md-2 col-lg-3"><strong>Contact</strong><br /><i className="fas fa-mobile-alt" />
                935728467<br /><i className="fas
                fa-phone-square-alt" /> 945790354<br /><i className="fas
