    ...
    <div>
        ...
        <div id="contact" className="container section">
            ...
            <div className="row justify-content-sm-center">
                <p className="col-sm-12 col-md-4 col-lg-3"><strong>Address</strong><br /><i className="fas fa-map-marker-alt" /> Setúbal, 2810-226 Almada<br /><i className="fas fa-map-marker-alt" /> Lisboa, Portugal</p>
