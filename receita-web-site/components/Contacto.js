    ...
    <div>
        ...
        <div id="contact" className="container mt-4">
            ...
            <div className="row justify-content-sm-center">
                ...
                <p className="col-sm-12 col-md-6 col-lg-4">
                    <strong>Contact</strong><br /><i className="fas fa-mobile-alt mr-1" />935728467<i className="fas fa-phone-square-alt ml-2 mr-1" /> 945790354<br /><i className="fas fa-envelope-square mr-1" />
                     chefsassyfernandescv@gmail.com
                </p>
