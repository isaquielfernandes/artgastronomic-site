...
const Footer = () => (
    <>
        ...
        <a className="btn btn-lg" href="https://facebook.com/chfsassy/" target="_blank" role="button"><i className="fa fa-facebook" /></a>
        <a className="btn btn-lg" href="https://www.youtube.com/channel/UCybV8OZ7XZ9U30ESJ_r2UCg" target="_blank" role="button"><i className="fa fa-youtube" /></a>
